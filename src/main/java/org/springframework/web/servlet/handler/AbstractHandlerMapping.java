...
//        return this.adaptedInterceptors.stream()
//                .filter(handlerInterceptor -> handlerInterceptor instanceof MappedInterceptor)
//                .map(handlerInterceptor -> (MappedInterceptor) handlerInterceptor)
//                .toArray();
