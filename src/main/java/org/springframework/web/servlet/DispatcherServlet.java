...
public class DispatcherServlet extends FrameworkServlet {
    ...
    protected void doService(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        //zsy
        attributesSnapshot = Collections.list(request.getAttributeNames()).stream()
                .filter(name -> this.cleanupAfterInclude || name.startsWith("org.springframework.web.servlet"))
                .collect(toMap(Function.identity(), request::getAttribute));
    ...
    protected void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            try {
                ...
                handlerExecutionChain = getHandler(processedRequest);//get chain by handlerMapping(request)
                ...
                boolean isGet = "GET".equals(method); //HttpMethod.GET.matches(method);//zsy
                if (isGet || "HEAD".equals(method)) {// HttpMethod.HEAD.matches(method);
                ...
                mv = handlerAdapter.handle(processedRequest, response, handler);
            ...
            triggerAfterCompletion(processedRequest, response, handlerExecutionChain, new NestedServletException("Handler processing failed", err));
        } finally {
            if (asyncManager.isConcurrentHandlingStarted()) {
